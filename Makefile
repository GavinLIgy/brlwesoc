...
hx8kdemo.blif: hx8kdemo.v spimemio.v simpleuart.v picosoc.v ../picorv32.v ./LFSR/lfsr.v ./simplerng/simplerng.v ./user_ram/user_ram.v
	yosys -ql hx8kdemo.log -p 'synth_ice40 -top hx8kdemo -blif hx8kdemo.blif' $^

hx8kdemo_tb.vvp: hx8kdemo_tb.v hx8kdemo.v spimemio.v simpleuart.v picosoc.v ../picorv32.v spiflash.v ./LFSR/lfsr.v ./simplerng/simplerng.v ./user_ram/user_ram.v
