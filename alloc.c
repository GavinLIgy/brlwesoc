...
* Version : V1.00
*
* 版权声明：本文为CSDN博主「泡在妞里的Feel」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
* 原文链接：https://blog.csdn.net/qq_21475601/article/details/77579462
********************************************************************************
*/
//#include <string.h>
#include "alloc.h"
...
#ifdef ICEBREAKER
#  define MEM_SIZE 0x20000 /*内存池的大小 128 KB */
#elif HX8KDEMO
#  define MEM_SIZE 0x200 /*内存池的大小 2 KB */
#else
